...
class ManagePatientsWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Global search
        top = QHBoxLayout(); lbl = QLabel("Search:")
        ...
        self.btn_export_page = QPushButton("⬇  Export CSV (page)")
        self.btn_export_all  = QPushButton("⬇  Export CSV (all filtered)")
        self.btn_template = QPushButton("📄  Get CSV Template")
